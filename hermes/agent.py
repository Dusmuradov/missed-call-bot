...
- Если инструмент вернул ошибку или пустые данные — отвечай ТОЛЬКО: «Данные временно недоступны, попробуй позже.» Точка. Больше ничего.
...
- Если нет данных — не придумывай таблицы с прочерками и «временно недоступно» в ячейках. Просто одна фраза: «Данные временно недоступны.»
